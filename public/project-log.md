...
user data was stored correctly.
...
24 February 2026
Started developing the admin dashboard where administrators can
view and manage customer orders. Added features allowing admins
to update order stages and manage bookings.
